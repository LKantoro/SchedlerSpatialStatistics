...
Estimated standard errors do match now but this was made work with some R tricks, and instead in the background is still 3.93, .304, and .004
...
nb <- poly2nb(wall_sp_ordered, queen = FALSE)
